...
activities = {
    ...
    "Drama Club": {
        "description": "Perform in theatrical productions and learn acting techniques",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["marcus@mergington.edu"]
    },
    "Photography Club": {
        "description": "Explore photography techniques and showcase artwork",
        "schedule": "Mondays, 4:00 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["aria@mergington.edu", "james@mergington.edu"]
    },
    "Debate Team": {
